...
\begin{sectionbox}
	...
	\begin{tablebox}{ll} %TODOSamuel
		...
		Ableitung: & $f'(t) \LT s F(s) - f(0)$ \\
		& $f''(t) \LT s^2 F(s) - sf(0) - f'(0)$\\
		\multicolumn{2}{l}{$f^{(n)} \LT s^n F(s) - s^{n-1} f(0) - s^{n-2} f'(0) \ldots - f^{(n-1)}(0)$}\\
		Integral: & $\int_0^t f(x) \diff x \LT \frac{1}{s} F(s)$\\
