...
\begin{sectionbox}
	...
	$\abs{\cx z}^2 = \cx z \cxc z = x^2+y^2$ \qquad $\sqrt[n]{\cx z}=\sqrt[n]{|\cx z|} \exp \left( \frac{\i \varphi}{n} + k\frac{2\pi\mathrm i}{n}\right)$ mit $k=1,\dots,n-1$
\end{sectionbox}
...
\begin{sectionbox}
	...
	\begin{itemize}\itemsep0pt
		...
		\item Cauchy-Riemann DGLs sind erfüllt auf Gebiet $G$:\\
