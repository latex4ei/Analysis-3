...
\begin{sectionbox}
	...
	\begin{cookbox}{Lösen eines Nullrandproblems für einen Stab}
		...
		\(b_{n}=\frac{2}{l} \int_{0}^{l} g(x)\sin(n\frac{\pi}{l}x)dx\) \qquad für \(n=1,2,3,4,... \)
		\\
...
\(a_{n}=\frac{2}{l}\int_0^l  g(x)\sin(n\frac{\pi}{l}x)dx\) \qquad für \(n=1,2,3,4,... \)\\
\(b_{n}=\frac{2}{n\pi c} \int_0^l  v(x)\sin(n\frac{\pi}{l}x)dx\) \qquad für \(n=1,2,3,4,... \)
\item Lösung \(u(x,t)\) als Reihendarstellung: %\vspace{-5pt}		 								% Platz sparen wo nur geht
